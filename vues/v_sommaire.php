	...
	<ul id="menuList">
		...
		if ($_SESSION ['typeUtilisateur'] == "Visiteur") {
           ...
           <li class="smenu"><a
			...
			title="Saisie fiche de frais ">Saisie fiche de frais</a></li>
		<li class="smenu"><a
			href="index.php?uc=etatFrais&action=selectionnerMois"
			title="Consultation de mes fiches de frais">Mes fiches de frais</a></li>
          <?php  }else{ ?>
           
             <li class="smenu"><a
			href="index.php?uc=valider&action=selectionneVisiteur"
			title="Valider fiche">Valider fiche de frais</a></li>
		<li class="smenu"><a
			href="index.php?uc=paiement&action=voirFicheaRembrouser"
